...
            else return grupos.First().Grupo.Id;
        ...
        public ActionResult Create([Bind(Include = "Id,ClaseId,CursoId,GrupoId")] Matricula matricula)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,ClaseId,CursoId,GrupoId")] Matricula matricula)
        {
            if (ModelState.IsValid)
            {
